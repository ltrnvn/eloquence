...
\
\
Then, when I wasn't training competitive matches, I took
pleasure in challenging multiple top-ranked players while being
alone on Call Of Duty: Black Ops 3 inpublic matches.
...
on <ExternalLink link="https://www.youtube.com/ephalys" text="Youtube" />.
\
\
...
\
\
I'm also streaming on <ExternalLink link="https://www.twitch.tv/ephalys" text="Twitch" /> from time to time.

### List of favourites games
